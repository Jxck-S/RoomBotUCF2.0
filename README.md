...
#### RoomBot
`__main__.py` This is the actual room bot that will reserve the rooms, it should be launched at like 11:58PM, it will wait exactly till 11:59PM to run itself. It will reserve the rooms for the [...]
